...
const test = 'thisismyteststring';
const testNumber = 839342879423;
...
function arrayFlipper(arr) {
    let flippedArr = [];
    for (let i = arr.length - 1; i >= 0; i--) {
        flippedArr.push(reverseCharacters(arr[i]));
    }
    return flippedArr;
}
...
console.log(arrayFlipper(arrayTest3));